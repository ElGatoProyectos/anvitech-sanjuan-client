...
function FormRegisterVacationMassive() {
  ...
  async function handleRegistrarDataMassive(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await postImage("workers/vacations/file", formData, session.data);
      setLoading(false);
        ...
        >
          <div>
            ...
            <Link
              target="_blank"
              download
              as="/files/formato_vacaciones_carga_masiva.xlsx"
              href="/files/formato_vacaciones_carga_masiva.xlsx"
...
export default FormRegisterVacationMassive;
